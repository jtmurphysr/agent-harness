...
from reviewers.models import ModelConfig, ModelResolutionError, ModelResolver
...
class TestModelResolver:
    ...
    def test_resolve_model_default_mapping(
        self, temp_model_map_path: Path, sample_model_map: dict
    ) -> None:
    ...
    def test_resolve_model_project_override(
        self, temp_model_map_path: Path, sample_model_map: dict
    ) -> None:
    ...
    def test_resolve_model_partial_project_override(
        self, temp_model_map_path: Path, sample_model_map: dict
    ) -> None:
    ...
    def test_resolve_model_unknown_class(
        self, temp_model_map_path: Path, sample_model_map: dict
    ) -> None:
    ...
    def test_resolve_model_no_matching_reviewer_override(
        self, temp_model_map_path: Path, sample_model_map: dict
    ) -> None:
