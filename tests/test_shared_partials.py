...
class TestSharedPartials:
    ...
    def test_output_contract_partial_valid(self):
        ...
        assert "### Closing Question" in content, (
            "Output contract must have 'Closing Question' section"
        )
        ...
        assert "(invariant: <id>)" in content, (
    ...
    def test_refusal_conditions_partial_valid(self):
        ...
        assert "backdoor" in content.lower() or "Backdoor" in content, (
            "Must address backdoor detection"
        )
