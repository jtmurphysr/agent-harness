...
from renderer.compose import CompositionError
...
class TestGeneratedFileValidator:
    ...
    def test_cli_main_validation_errors(
    ...
    def test_cli_main_validation_exception(
        self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch
    ) -> None:
    ...
    def test_generate_expected_content_with_compose_error(self, tmp_path: Path) -> None:
        ...
        with pytest.raises(CompositionError, match="No YAML frontmatter"):
    ...
    def test_cli_main_unexpected_exception(
        ...
        from scripts.validate_generated_files import GeneratedFileValidator, main
